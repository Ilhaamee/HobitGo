    ...
    <div v-else class="chat-container">
      <div class="chat-list">
        ...
        <div
          ...
          class="chat-item" :class="{ active: activeTab === conv.user_id }"
...
.message-input input { flex: 1; padding: 12px 16px; border: 1px solid #eee; border-radius: 24px; font-size: 14px; outline: none; font-family: inherit; }
