...
.close { position: absolute; top: 12px; right: 12px; background: transparent; border: none; font-size: 20px; cursor: pointer; opacity: 0.6; color: var(--text-primary); }
...
.hobby-info p { font-size: 13px; color: var(--text-secondary); margin: 0; }
